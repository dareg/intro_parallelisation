...
Mesurer le temps pris par une commande: time macommande

Lancer une commande en tache de fond: macommande &

Trouver un fichier: find -name "nomdufichier"

Lancer un script: ./mon\_script.sh

Chercher un mot dans des fichiers: grep mot
